...
void loop()
{
  ...
  //TODO Recieve GPS coordinates to create repetoire
  ...
  i++;
  // TODO Replace i with command from server -> LORA go to sleep
  if (i == 5){
  ...
  // TODO Calulate relative GPS coordinates 
  // TODO Send GPS coordinates -> LoRa

  // TODO Measure Battery level
  // TODO Send battery level to server
